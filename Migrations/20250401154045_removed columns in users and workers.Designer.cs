...
namespace LVTS.Migrations
{
    ...
    [Migration("20250401154045_removed columns in users and workers")]
    partial class removedcolumnsinusersandworkers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LVTS.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("LVTS.Models.Admin", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("LVTS.Models.Admin", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
